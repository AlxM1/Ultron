...
exports.fullAuditRouter = void 0;
const express_1 = require("express");
const pool_1 = require("../db/pool");
const scorers_1 = require("../scorers");
exports.fullAuditRouter = (0, express_1.Router)();
exports.fullAuditRouter.post('/', async (req, res) => {
    const { url } = req.body;
    ...
    try {
        ...
        for (const page of pages) {
            try {
                const result = await (0, scorers_1.runAudit)(page.url);
        ...
        const dimKeys = ['ai_citability', 'schema_readiness', 'eeat_signals', 'content_structure', 'platform_visibility'];
        const aggregated = {};
        ...
        const overallScore = Math.round(aggregated.ai_citability.score * 0.25 +
        ...
        try {
         ...
         VALUES ($1, 'complete', $2, $3, $4, NOW())`, [targetUrl, overallScore, JSON.stringify(aggregated), JSON.stringify(uniqueRecs)]);
        }
        catch (dbErr) {
