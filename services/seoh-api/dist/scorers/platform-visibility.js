...
exports.scorePlatformVisibility = scorePlatformVisibility;
/**
 ...
 */
function scorePlatformVisibility(otherScores) {
    const issues = [];
    // Weighted average of other scores as a proxy
    const estimated = Math.round(otherScores.ai_citability * 0.35 +
